...
class RegistrationView(ctk.CTkFrame):
    ...
    def __init__(self, parent, controller):
        ...
        # ALTERAÇÃO AQUI: Adiciona a validação quando o usuário sai do campo
        ...
        # ALTERAÇÃO AQUI: Campo de observação agora é obrigatório
    ...
    def add_or_update_test(self):
        ...
        op_a = self.combo_teste_op_a.get().upper()
        num_b = self.entry_teste_num_b.get().upper()
        op_b = self.combo_teste_op_b.get().upper()
        status = self.combo_teste_status.get().upper()
        obs = self.entry_teste_obs.get().upper()
        
        # ALTERAÇÃO AQUI: Adicionada validação para o campo 'obs'
    ...
    # ALTERAÇÃO AQUI: Nova função para validar e formatar o campo de horário
    def _validate_and_format_horario(self, event=None):
        """Valida e formata o horário quando o usuário sai do campo."""
