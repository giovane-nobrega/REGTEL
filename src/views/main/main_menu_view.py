...
#        para os botões dentro de um contêiner central.
# ==============================================================================
...
class MainMenuView(ctk.CTkFrame):
    """
    Tela do menu principal da aplicação, exibindo opções para o usuário.
    """
    def __init__(self, parent, controller):
        ...
        self.user_info_label.place(relx=0.5, rely=0.1, anchor="n") # Posiciona o título centralizado no topo

        self.email_label = ctk.CTkLabel(self, text="", text_color="gray70")
        self.email_label.place(relx=0.5, rely=0.18, anchor="n") # Posicionado abaixo do título
        ...
        # Rótulo para exibir a versão da aplicação.
    ...
    def on_show(self):
        ...
        """
        pass # A atualização das infos do usuário é feita via `update_user_info`
    ...
    def update_user_info(self, email, user_profile, app_version):
        ...
        self.user_info_label.configure(text=f"Bem-vindo, {welcome_name}!") # Atualiza o título de boas-vindas
