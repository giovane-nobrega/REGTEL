...
#            onde administradores podem aprovar ou rejeitar solicitações de acesso.
# ==============================================================================
...
class AccessManagementView(ctk.CTkFrame):
    ...
    def __init__(self, parent, controller):
        """
        Inicializa a AccessManagementView.
        ...
        self.pending_users_frame.grid(row=1, column=0, fill="both", expand=True, pady=10, padx=20)
    ...
    def _handle_access_update(self, email, new_status):
        ...
        self.load_access_requests() # Recarrega a lista após a atualização
