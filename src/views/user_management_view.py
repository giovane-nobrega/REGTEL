...
class UserManagementView(ctk.CTkFrame):
    ...
    def on_show(self):
        """Chamado sempre que a tela é exibida. Inicia o carregamento dos dados."""
    ...
    def _populate_all_users(self, all_users_list):
        """Popula a UI com os cards de usuários, incluindo controles de edição."""
    ...
    def _on_main_group_change(self, email, selected_main_group, initial_load=False):
        """Atualiza as opções de subgrupo e empresa com base no grupo principal."""
    ...
    def _on_sub_group_change(self, email, selected_sub_group, initial_load=False):
        """Atualiza as opções de empresa com base no grupo e subgrupo."""
        widgets = self.profile_updaters[email]
    ...
    def save_profile_changes(self):
        """Coleta e salva as alterações de perfil em lote."""
        changes = {}
